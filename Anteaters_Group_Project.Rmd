...
```{r}
ggplot(data=emoji_clean, aes(x=opsys, y=freq_emu)) + geom_violin(alpha = 0.5) +
...
Notes on the violin plot:
- The LQ and median look very similar if not the same for the two operating systems
- The UQ and overall range is much higher for Apple - Apple users seem more likely to use a higher number of emojis in a day
- Android is more densely concentrated around the median
- There's only one outlier - at 24 emojis/day under Apple
