...
m2intq2$coefficients[4]
m2intq2$coefficients[5]
- (m2intq2$coefficients[5] + m2intq2$coefficients[4])

m2intq2$coefficients[6] + m2intq2$coefficients[4] + m2intq2$coefficients[1] + m2intq2$coefficients[3]

m2intq2$coefficients[7]
- (m2intq2$coefficients[6] + m2intq2$coefficients[7])

m2intq2$coefficients[1] - (m2intq2$coefficients[5] + m2intq2$coefficients[4] +m2intq2$coefficients[6] + m2intq2$coefficients[7])
augment(m2intq2, 
        newdata = data.frame(freq_emu = c(0,0,0),
                             age_mc = c(0,0,0, 1, 1, 1),
                             em_cat = c("loudly crying face", 
