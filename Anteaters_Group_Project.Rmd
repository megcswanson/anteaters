...
```{r}
#Haven't written the interpretation for this one yet. Also not sure if I'm useing (all) the correct predictors. 

m1q2 <- lm(EVS ~ em_cat + I(age-mean(age)) + freq_emu, data = emoji_clean)
summary(m1q2)
